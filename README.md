...
Demo: [https://welisagita.github.io/api-wilayah-indonesia/](https://welisagita.github.io/api-wilayah-indonesia/)
...
```
GET https://welisagita.github.io/api-wilayah-indonesia/api/provinces.json
```
...
```
GET https://welisagita.github.io/api-wilayah-indonesia/api/regencies/{provinceId}.json
```

Contoh untuk mengambil daftar kab/kota di provinsi Aceh (ID = 11):

```
GET https://welisagita.github.io/api-wilayah-indonesia/api/regencies/11.json
```
...
```
GET https://welisagita.github.io/api-wilayah-indonesia/api/districts/{regencyId}.json
```

Contoh untuk mengambil daftar kecamatan di Aceh Selatan (ID = 1103):

```
GET https://welisagita.github.io/api-wilayah-indonesia/api/districts/1103.json
```
...
```
GET https://welisagita.github.io/api-wilayah-indonesia/api/villages/{districtId}.json
```

Contoh untuk mengambil daftar kelurahan di Trumon (ID = 1103010):

```
GET https://welisagita.github.io/api-wilayah-indonesia/api/villages/1103010.json
```
...
```
GET https://welisagita.github.io/api-wilayah-indonesia/api/province/{provinceId}.json
```

Contoh untuk mengambil data provinsi Aceh (ID = 11):

```
GET https://welisagita.github.io/api-wilayah-indonesia/api/province/11.json
```
...
```
GET https://welisagita.github.io/api-wilayah-indonesia/api/regency/{regencyId}.json
```

Contoh untuk mengambil data kabupaten Aceh Selatan (ID = 1103):

```
GET https://welisagita.github.io/api-wilayah-indonesia/api/regency/1103.json
```
...
```
GET https://welisagita.github.io/api-wilayah-indonesia/api/district/{districtId}.json
```

Contoh untuk mengambil data kecamatan Trumon Timur (ID = 1103011):

```
GET https://welisagita.github.io/api-wilayah-indonesia/api/district/1103011.json
```
...
```
GET https://welisagita.github.io/api-wilayah-indonesia/api/village/{villageId}.json
```

Contoh untuk mengambil data kelurahan Jambo Dalem (ID = 1103011010):

```
GET https://welisagita.github.io/api-wilayah-indonesia/api/village/1103011010.json
```
